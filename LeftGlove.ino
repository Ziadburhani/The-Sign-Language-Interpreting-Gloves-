...
//flexvalue_1 = constrain(flexvalue_1,sensorMin1, sensorMax1);
  ...
  float angle5= map(flexvalue_5, sensorMin5, sensorMax5, 0, 100);
  float angle4= map(flexvalue_4, sensorMin4, sensorMax4, 0, 100);
  float angle3= map(flexvalue_3, sensorMin3, sensorMax3, 0, 100);
  float angle2= map(flexvalue_2, sensorMin2, sensorMax2, 0, 100);
  float angle1= map(flexvalue_1, sensorMin1, sensorMax1, 0, 100); 
...
if((flexvalue_1>2700)and(flexvalue_2>3900)and(flexvalue_3>3500)and(flexvalue_4>3800)and(flexvalue_5>3900)) {
  SerialBT.println('A');
  Serial.println("Letter A");
  delay(2000);
  
}
else if((flexvalue_1>3100)and(flexvalue_2>3900)and(flexvalue_3>3500)and(flexvalue_4>3600)and(flexvalue_5>2500)) {
  SerialBT.println('I');
  Serial.println("Letter I");
  delay(2000);}
 else if((flexvalue_1>2500)and(flexvalue_2>2300)and(flexvalue_3>3700)and(flexvalue_4>3700)and(flexvalue_5>3900)) {
  SerialBT.println('Z');
  Serial.println("Letter Z");
  delay(2000);
 }
 else if((flexvalue_1>3100)and(flexvalue_2>2700)and(flexvalue_3>3000)and(flexvalue_4>3300)and(flexvalue_5>3700)) {
  SerialBT.println('D');
